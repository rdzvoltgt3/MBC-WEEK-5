"""
app.py — Prakiraan Suhu Udara Jena dengan LSTM & GRU (versi 2.0)

Satu kode untuk dua aplikasi:
    streamlit run app_lstm.py   -> aplikasi model LSTM (GRU tampil sebagai pembanding)
    streamlit run app_gru.py    -> aplikasi model GRU  (LSTM tampil sebagai pembanding)
    streamlit run app.py        -> sama dengan app_lstm.py

Model berformat ONNX (hasil ekspor dari PyTorch, lihat training/train_export.py) dan dijalankan
dengan onnxruntime, sehingga server tidak perlu memasang PyTorch.
"""
